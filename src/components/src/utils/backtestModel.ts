...
const v3Core: Partial<ModelSettings> = {
  enableDynamicElo: true,
  dynamicEloWeight: 0.5,
  separateOutcomeModel: true,
  outcomeModelWeight: 0.5,
  drawModelWeight: 0.55,
  scoreOutcomeCalibrationWeight: 0.72,
};

const v3Balanced: Partial<ModelSettings> = {
  ...resultV1Light,
  ...smartDrawLight,
  ...v3Core,
...
const v3Result: Partial<ModelSettings> = {
  ...resultV1Light,
  ...smartDrawLight,
  ...v3Core,
  scoreModel: 'hybrid_dc_bivariate',
  outcomeModelWeight: 0.65,
  drawModelWeight: 0.5,
  scoreOutcomeCalibrationWeight: 0.85,
};

const v3Draw: Partial<ModelSettings> = {
  ...resultV1Balanced,
  ...smartDrawMedium,
  ...v3Core,
  scoreModel: 'ensemble_v3',
  outcomeModelWeight: 0.5,
  drawModelWeight: 0.75,
  scoreOutcomeCalibrationWeight: 0.78,
};

const v3Mpp: Partial<ModelSettings> = {
  ...resultV1Light,
  ...smartDrawLight,
  ...v3Core,
  scoreModel: 'ensemble_v3',
...
export const modelCalibrationCandidates: ModelCalibrationCandidate[] = [
  ...
  {
    id: 'v3_balanced_ensemble',
    name: 'v3 Ensemble équilibré',
    description: 'Elo dynamique + modèle 1/N/2 séparé + modèle nul séparé + recalibrage des scores exacts.',
    settingsPatch: { ...stableModelBase, ...v3Balanced },
  },
  {
    id: 'v3_result_focus',
    name: 'v3 Résultat 1/N/2',
    description: 'Version v3 qui privilégie le bon résultat avant le score exact.',
    settingsPatch: { ...stableModelBase, ...v3Result },
  },
  {
    id: 'v3_draw_focus',
    name: 'v3 Nuls renforcés',
    description: 'Version v3 plus sensible aux profils de nuls et aux matchs fermés.',
    settingsPatch: { ...stableModelBase, ...v3Draw },
  },
  {
    id: 'v3_mpp',
    name: 'v3 MPP prudent',
    description: 'Version v3 orientée MPP : température un peu plus plate et recalibrage 1/N/2 fort.',
    settingsPatch: { ...stableModelBase, ...v3Mpp },
  },
  {
    id: 'dc_pure_stable',
...
export const scoreModelPresets: ScoreModelPreset[] = [
  ...
  },
  {
    ...
    label: 'Ensemble v3',
    scoreModel: 'ensemble_v3',
    description: 'Combine Poisson, Dixon-Coles, Bivariate et recalibrage 1/N/2 séparé.',
    settingsPatch: {
      enableDynamicElo: true,
      separateOutcomeModel: true,
      dynamicEloWeight: 0.5,
      ...
      drawModelWeight: 0.6,
      scoreOutcomeCalibrationWeight: 0.75,
    },
  },
];
